    ...
    <section className="relative overflow-hidden rounded-[32px] border border-border bg-surface-muted p-6 shadow-[0_12px_28px_rgba(38,31,24,0.05)] sm:p-8">
      ...
      <div className="relative grid gap-6 xl:grid-cols-[minmax(0,1fr)_auto] xl:items-end">
        <div className="min-w-0 xl:max-w-none">
          ...
          <h1 className="mt-4 text-[1.92rem] font-semibold leading-[1.1] tracking-[-0.03em] text-foreground sm:text-4xl xl:max-w-none">
            {title}
          </h1>
        ...
        {actions ? (
          <div className="grid w-full max-w-sm gap-3 sm:flex sm:max-w-none sm:flex-row sm:flex-wrap xl:justify-self-end [&>*]:w-full sm:[&>*]:w-auto">
            {actions}
          </div>
        ) : null}
      </div>
